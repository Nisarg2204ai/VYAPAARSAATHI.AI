...
import './globals.css';
import './miracle-3d.css';
import { I18nProvider } from '../components/i18n-provider';
import { DeepFlowBackground } from '../components/deepflow-background';
import { Miracle3DEffects } from '../components/miracle-3d-effects';
  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <link 
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,700&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" 
          rel="stylesheet" 
        />
      </head>
